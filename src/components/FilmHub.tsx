      ...
      <div className="nedi-container">
        ...
        >
            ...
            {festivals.map((festival, index) => (
              ...
              >
                <div className="relative h-60">
                  ...
                  <button className="absolute inset-0 m-auto w-16 h-16 z-20 text-white hover:scale-110 transition-transform">
                    <PlayCircle size={64} className="fill-white/10" />
                  </button>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="#" className="btn-outline inline-flex items-center justify-center">
                      Submit Film <ExternalLink size={16} className="ml-2" />
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-16 glass-card p-8 text-center">
            ...
            <a href="#" className="btn-secondary inline-block mx-auto">
