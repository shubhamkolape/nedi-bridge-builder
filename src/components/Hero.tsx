      ...
      <div className="container mx-auto px-4 z-10 py-20 md:py-0">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight animate-fade-up">
            Building Bridges Through <span className="text-nedi-orange">Culture</span>, Heritage, Film, and Innovation
          </h1>
          
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl animate-fade-up" style={{animationDelay: '0.2s'}}>
            NEDI is the driving force behind cultural preservation, economic empowerment, and global connectivity for Northeast India.
          </p>
